...
const modal =
    document.getElementById("bookDialog");
...
const readingEmpty =
    document.getElementById("reading-empty");
...
const totalBooksElement =
    document.getElementById("total-books");

const booksReadElement =
    document.getElementById("books-read");

const booksReadingElement =
    document.getElementById("books-reading");
...
function openEditBookModal(book) {
    ...
    bookForm.elements.status.value =
        book.status;
...
bookForm.addEventListener(
    ...
    event => {
        ...
        if (
            ...
            showAlert(
                "Please fill in all book information."
            );
...
function openBookDetails(id) {
    ...
    if (bookDetails) {
        ...
        bookDetails.classList.remove(
            "empty"
        );


        bookDetails.classList.add(
            "open"
        );
...
function finishReading(id) {
    ...
    if (
        ...
        showAlert(
            `You are on page ${book.currentPage}. Finish the book first!`
        );
    ...
    showAlert(
        `Congratulations! You finished "${book.title}" 🎉`
    );
...
function updateCurrentPage(
    ...
    if (
        ...
        showAlert(
            "You reached the last page. You can finish the book now! 🎉"
        );
...
function addPageTrackerToDetails(
    book
) {
    ...
    const existing =
        bookDetails.querySelector(
            ".details-page-tracker"
        );
...
function confirmDelete() {
    ...
    showAlert(
        `"${deletedBook.title}" was removed from your library.`
    );
...
function updateStats() {
    ...
    if (booksReadingElement) {
        ...
        booksReadingElement.textContent =
            reading;
    ...
    if (booksNotReadElement) {
        ...
        booksNotReadElement.textContent =
            notRead;
...
console.log(
    "📚 Cozy Library initialized successfully."
);
